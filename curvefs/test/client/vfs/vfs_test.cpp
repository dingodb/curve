...
TEST_F(VFSTest, MkDirs) {
    ...
    // EXISTS(vfs->MkDirs("/f1", 0755));
    // NOT_DIR(vfs->MkDirs("/f1/d1", 0755));

    // OK(vfs->Create("/d1/f2", 0644));
    // EXISTS(vfs->MkDirs("/d1/f2", 0755));
    // NOT_DIR(vfs->MkDirs("/d1/f2/d2", 0755));
}
